-- TEST4 authoritative custom-race reputation model.
-- Remove custom-race bits from every reputation slot first.
UPDATE faction SET
 reputation_race_mask_1 = reputation_race_mask_1 & ~(256|2048|4096|8192|16384),
 reputation_race_mask_2 = reputation_race_mask_2 & ~(256|2048|4096|8192|16384),
 reputation_race_mask_3 = reputation_race_mask_3 & ~(256|2048|4096|8192|16384),
 reputation_race_mask_4 = reputation_race_mask_4 & ~(256|2048|4096|8192|16384);
-- Worgen inherits Human, High Elf inherits Night Elf; Horde custom races inherit Orc.
...
-- Home reputations must apply only to their own custom race.
