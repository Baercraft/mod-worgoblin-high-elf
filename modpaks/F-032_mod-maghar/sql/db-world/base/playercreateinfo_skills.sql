...
-- UPDATE `playercreateinfo_skills` SET `racemask` = `racemask`|8192 WHERE `skill` = 46 AND `racemask` = 36; -- Guns
UPDATE `playercreateinfo_skills` SET `racemask` = `racemask`|8192 WHERE `skill` = 45 AND `racemask` = 650; -- Bows
UPDATE `playercreateinfo_skills` SET `racemask` = `racemask`|8192 WHERE `skill` = 173 AND `racemask` = 735; -- Daggers
...
UPDATE `playercreateinfo_skills` SET `racemask` = `racemask`|8192 WHERE `skill` = 109; -- Orcish language

/* Add racial skills */
DELETE FROM `playercreateinfo_skills` WHERE `raceMask` IN (8192) AND `classMask` = 0;
INSERT IGNORE INTO `playercreateinfo_skills` (`raceMask`, `classMask`, `skill`, `rank`, `comment`) VALUES
