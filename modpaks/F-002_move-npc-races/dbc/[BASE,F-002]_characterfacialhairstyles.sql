...
UPDATE `characterfacialhairstyles` SET `race` = @Skeleton          WHERE `race` = 14;
UPDATE `characterfacialhairstyles` SET `race` = @Vrykul            WHERE `race` = 15;
UPDATE `characterfacialhairstyles` SET `race` = @Tuskarr           WHERE `race` = 16;
UPDATE `characterfacialhairstyles` SET `race` = @ForestTroll       WHERE `race` = 17;
UPDATE `characterfacialhairstyles` SET `race` = @Tuskarr           WHERE `race` = 18;
