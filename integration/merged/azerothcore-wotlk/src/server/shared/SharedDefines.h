...
enum Races
{
    ...
    //RACE_ALLIANCEPANDAREN   = 15, // TITLE Tushui Pandaren
    //RACE_HORDEPANDAREN      = 16, // TITLE Huojin Pandaren
    //RACE_NIGHTBORNE         = 17, // TITLE Nightborne
    //RACE_HIGHMOUNTAINTAUREN = 18, // TITLE Highmountain Tauren
    //RACE_VOIDELF            = 19, // TITLE Void Elf
    //RACE_LIGHTFORGEDDRAENEI = 20, // TITLE Lightforged Draenei
    //RACE_ZANDALARITROLL     = 21, // TITLE Zandalari Troll
    //RACE_KULTIRAN           = 22, // TITLE Kul Tiran
    //RACE_GILNEAN        = 23, // TITLE Gilnean
    //RACE_DARKIRONDWARF  = 24, // TITLE Dark Iron Dwarf
    //RACE_VULPERA        = 25, // TITLE Vulpera
    //RACE_MECHAGNOME     = 26, // TITLE Mechagnome
    //RACE_ALLIANCEDRACTHYR = 27, // TITLE Alliance Dracthyr
...
//  HordePandaren     = 16,
//  Nightborne        = 17,
// HighmountainTauren = 18,
//  VoidElf           = 19,
// LightforgedDraenei = 20,
//  ZandalariTroll    = 21,
//  KulTiran          = 22,
    Gilnean           = 23,
//  DarkIronDwarf     = 24,
