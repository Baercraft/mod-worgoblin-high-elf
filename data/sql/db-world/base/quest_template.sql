...
/* Allows Worgen and Goblin to complete race-restricted class quests (non-ARAC, surgical approach) */
/*
...
-- Maghar inherit Orc race restrictions
UPDATE `quest_template` SET `AllowableRaces` = `AllowableRaces` | 8192 WHERE (`AllowableRaces` & 2) <> 0 AND `AllowableRaces` > 0;
