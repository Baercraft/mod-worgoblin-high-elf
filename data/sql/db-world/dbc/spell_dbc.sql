...
(
	...
	'두 가지 모습', -- Name_Lang_enGB
	'Deux formes', -- Name_Lang_koKR
	'Zwei Gestalten', -- Name_Lang_frFR
	'双形态', -- Name_Lang_deDE
	'雙重形態', -- Name_Lang_enCN
	'Dos formas', -- Name_Lang_zhCN
	'Dos formas', -- Name_Lang_enTW
	'Два облика', -- Name_Lang_zhTW
	'', -- Name_Lang_esES
	'', -- Name_Lang_esMX
	'', -- Name_Lang_ruRU
	'', -- Name_Lang_ptPT
	...
	'현재와 다른 모습으로 변신합니다.', -- Description_Lang_enGB
	'Vous prenez la forme qui n\'était pas active.', -- Description_Lang_koKR
	'Verwandelt Euch in Eure momentan inaktive Form.', -- Description_Lang_frFR
	'使你变成另一个形态。', -- Description_Lang_deDE
	'轉變成目前未啟動的那個形態。', -- Description_Lang_enCN
	'Vuelves a tu otra forma.', -- Description_Lang_zhCN
	'Vuelves a tu otra forma.', -- Description_Lang_enTW
	'Принять противоположный облик.', -- Description_Lang_zhTW
	'', -- Description_Lang_esES
	'', -- Description_Lang_esMX
	'', -- Description_Lang_ruRU
	'', -- Description_Lang_ptPT
