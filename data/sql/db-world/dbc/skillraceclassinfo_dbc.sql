...
(973, 793, 2048, 0, 0, 0, 0, 0); -- To make sure Worgen are eligible for the racials they acquire.
...
/* Maghar inherits Orc race validity for weapon/armor/profession skills. */
UPDATE `skillraceclassinfo_dbc` SET `RaceMask` = `RaceMask` | 8192 WHERE (`RaceMask` & 2) <> 0;
REPLACE INTO `skillraceclassinfo_dbc` (`ID`,`SkillID`,`RaceMask`,`ClassMask`,`Flags`,`MinLevel`,`SkillTierID`,`SkillCostIndex`) VALUES (1141,792,8192,1535,1170,0,0,0);
